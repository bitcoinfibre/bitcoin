...
public:
    ...
    std::vector<uint256> vTxHashes GUARDED_BY(cs); //!< All tx witness hashes/entries in mapTx, in random order
    std::vector<txiter> vTxnUnordered GUARDED_BY(cs); //!< All txn in the same order as vTxHashes
